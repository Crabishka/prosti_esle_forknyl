...
class TextSelectionMenu extends StatefulWidget {
  ...
  const TextSelectionMenu({super.key, this.textDirection, this.onSelected, this.themeData, this.localizations});
            ...
            decoration: BoxDecoration(
              color: _isHovering
                  ? widget.themeData!.useMaterial3
                      ? widget.themeData!.colorScheme.onSurface.withOpacity(0.08)
                      : (widget.themeData!.colorScheme.brightness == Brightness.light)
